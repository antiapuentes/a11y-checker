...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
%%  WCAG 2.0: Success criterions (Level A of Conformance) in terms of
%%            the HTML techniques
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
-export([success_criterion_1_1_1_non_text_content/3,
         success_criterion_1_2_1_time_based_media/3,
         success_criterion_1_2_2_captions/3,
         success_criterion_1_2_3_audio_desc_or_media_alternative/3,
         success_criterion_1_3_1_info_and_relationships/3,
         success_criterion_1_3_2_meaningful_sequence/3,
         success_criterion_1_3_3_audio_sensory_characteristics/3,
         success_criterion_1_4_1_use_of_color/3,
         success_criterion_1_4_2_audio_control/3,
         success_criterion_2_1_1_keyboard/3,
         success_criterion_2_1_2_no_keyboard_trap/3,
         success_criterion_2_2_1_timing_adjustable/3,
         success_criterion_2_2_2_pause_stop_hide/3,
         success_criterion_2_3_1_three_flashes_or_below_threshold/3,
         success_criterion_2_4_1_bypass_blocks/3,
         success_criterion_2_4_2_page_titled/3,
         success_criterion_2_4_3_focus_order/3,
         success_criterion_2_4_4_link_purpose/3,
         success_criterion_3_1_1_language_of_page/3,
         success_criterion_3_2_1_on_focus/3,
         success_criterion_3_2_2_on_input/3,
         success_criterion_3_3_1_error_identification/3,
         success_criterion_3_3_2_labels_or_instructions/3,
...
eval(TechList) ->
    lists:foldl(fun(A, B) -> A and B end,
                true,
                [eval_tech(TechFun, TechArgs, TechName) || {TechFun, TechArgs, TechName} <- TechList]).
...
success_criterion_1_1_1_non_text_content(_LevelOfConformance, Html, EntryType) ->
    ...
    eval([
          ...
          {fun html_tech:h36_only_well_formed_input_images/1,        [ScannedHtml], "H36"},
          {fun html_tech:h37_only_well_formed_images/1,              [ScannedHtml], "H37"},
          ...
          {fun html_tech:h67_only_well_formed_or_ignored_images/1,   [ScannedHtml], "H67"},
...
success_criterion_1_2_1_time_based_media(_, _, _) ->
    true.
...
success_criterion_1_2_2_captions(_, _, _) ->
    true.
...
success_criterion_1_3_1_info_and_relationships(_LevelOfConformance, Html, EntryType) ->
    ...
    eval([
          {fun html_tech:h44_only_labeled_form_controls/1,           [ScannedHtml], "H44"},
          {fun html_tech:h65_only_labeled_or_titled_form_controls/1, [ScannedHtml], "H65"},
          {fun html_tech:h71_only_descriptive_fieldsets/1,           [ScannedHtml], "H71"}
         ]).
...
success_criterion_1_3_2_meaningful_sequence(_, _, _) ->
    true.
...
success_criterion_1_3_3_audio_sensory_characteristics(_, _, _) ->
    true.
...
success_criterion_1_4_1_use_of_color(_, _, _) ->
    true.
...
success_criterion_1_4_2_audio_control(_, _, _) ->
    true.
...
success_criterion_2_1_1_keyboard(_, _, _) ->
    true.
...
success_criterion_2_1_2_no_keyboard_trap(_, _, _) ->
    true.
...
success_criterion_2_2_1_timing_adjustable(_, _, _) ->
    true.
...
success_criterion_2_2_2_pause_stop_hide(_, _, _) ->
    true.
...
%% Non-Interference.
success_criterion_2_3_1_three_flashes_or_below_threshold(_, _, _) ->
    true.
...
%% operability.
success_criterion_2_4_3_focus_order(_, _, _) ->
    true.
...
success_criterion_3_2_1_on_focus(_, _, _) ->
    true.
...
success_criterion_3_3_1_error_identification(_, _, _) ->
    true.
...
success_criterion_4_1_1_parsing(_LevelOfConformance, Html, EntryType) ->
    eval([
          ...
          {fun html_tech:h75_page_is_well_formed/2,      [Html, EntryType], "H75"},
          {fun html_tech:h88_page_is_valid/2,            [Html, EntryType], "H88"},
          {fun html_tech:h93_unique_ids/2,               [Html, EntryType], "H93"}
         ]).
